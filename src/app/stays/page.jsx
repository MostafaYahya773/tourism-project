  ...
  return (
    <div className="grid grid-rows-auto gap-y-10">
      ...
      >
        ...
        <div className="filtring absolute w-full -bottom-[270px] md:-bottom-24 z-[200]">
          <FindCarFilter />
        </div>
      </div>
      <div className="plans mt-[260px] md:mt-20 px-2 md:px-10">
        <OurPlans />
      </div>
      <div className="select mt-10 px-2 md:px-10">
        <SelectTwo />
      </div>
      <div className="recent  px-2 md:px-10 overflow-x-auto  ">
        <RecentSearch />
      </div>
